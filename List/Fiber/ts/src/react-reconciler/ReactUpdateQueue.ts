...
export function createUpdate( expirationTime: number ) {
  return {
    expirationTime,
...
export function processUpdateQueue<State>( workInProgress: FiberNode, queue: UpdateQueue<State>, props: any, instance: any, renderExpirationTime: number ) {
